...
function ComprarCasas () {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/partida/construir`,{
    ...
    return (
        <div className="code-container">
            ...
            <h1 className="code-title">Comprar Casas</h1>
            <form onSubmit={handleSubmit}>
                ...
                <div className="input-container">
                    <label htmlFor="numCasas">Numero de casas</label>
                    <input 
                    type="number" 
                    id="numCasas"
                    value={numCasas} 
