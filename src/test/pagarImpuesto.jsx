...
function Impuesto () {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/partida/pagar/impuesto/${id_casilla}`,{
    ...
    return (
        <div className="code-container">
            ...
            <h1 className="code-title">Pagar Impuesto</h1>
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit">Pagar Renta</button>
            </form>
            {result && (
